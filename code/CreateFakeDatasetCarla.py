...
imagewidth = 960
imageHight = 540
sorceimagesFoldersList = ["/home/aitester/Datasets/Carla/rgb"]
ground_truth_label_map = ["/home/aitester/Datasets/Carla/semantic_segmentation"]
...
infodict = {
    ...
    "Fence": [100, 40, 40, 11],
    "other": [55, 90, 80, 0],
    "Pedestrian": [220, 20, 60, 24],
    "infrastructure": [153, 153, 153, 17],
    "RoadLine": [157, 234, 50, 7],
